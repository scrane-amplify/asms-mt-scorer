...
confusionMatrix(data = exact_transfer_summary$temperature_correct, 
                reference = exact_transfer_summary$temperature)
```
...
confusionMatrix(data = exact_transfer_summary$absorption_correct, 
                reference = exact_transfer_summary$absorption)
```
...
confusionMatrix(data = exact_transfer_summary$ice_correct, 
                reference = exact_transfer_summary$ice)
```
...
confusionMatrix(data = exact_transfer_summary$molecule_concentration_correct, 
                reference = exact_transfer_summary$molecule_concentration)
```
...
confusionMatrix(data = exact_transfer_summary$human_activity_concentration_correct, 
                reference = exact_transfer_summary$human_activity_concentration)
```